...
public class ClientOne {
    ...
    private static Logger log = LoggerFactory.getLogger(ClientOne.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("clientOne started!");
        final PathChildrenCache childrenCache = new PathChildrenCache(clientOne.client, REDIS_CONFIG_PATH, true);

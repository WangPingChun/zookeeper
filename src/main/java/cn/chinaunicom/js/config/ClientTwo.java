...
public class ClientTwo {
    ...
    private static Logger log = LoggerFactory.getLogger(ClientTwo.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("clientTwo started!");
        final PathChildrenCache childrenCache = new PathChildrenCache(clientTwo.client, REDIS_CONFIG_PATH, true);
